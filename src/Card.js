    ...
    render() {
        ...
        return (
            <article className="card">
                <header>
                    <h1><a href={this.props.fields.link} rel="noopener">{this.props.fields.title}</a></h1>
                </header>
                <section>
                    {this.props.fields.media && <a href={this.props.fields.link} rel="noopener"><img src={this.props.fields.media} alt={this.props.fields.title} /></a>}
                    {this.props.fields.content && <p><a href={this.props.fields.link} rel="noopener">{this.props.fields.content}</a></p>}
                </section>
                <footer>
